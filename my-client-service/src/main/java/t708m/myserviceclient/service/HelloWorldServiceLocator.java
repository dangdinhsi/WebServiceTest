...
public class HelloWorldServiceLocator extends org.apache.axis.client.Service implements t708m.myserviceclient.service.HelloWorldService {
    ...
    public t708m.myserviceclient.service.HelloWorld getHelloWorldPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            t708m.myserviceclient.service.HelloWorldPortBindingStub _stub = new t708m.myserviceclient.service.HelloWorldPortBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (t708m.myserviceclient.service.HelloWorld.class.isAssignableFrom(serviceEndpointInterface)) {
                t708m.myserviceclient.service.HelloWorldPortBindingStub _stub = new t708m.myserviceclient.service.HelloWorldPortBindingStub(new java.net.URL(HelloWorldPort_address), this);
                _stub.setPortName(getHelloWorldPortWSDDServiceName());
                return _stub;
            }
        }
